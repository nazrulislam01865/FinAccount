...
return [
    'defaults' => [
        ...
        'cta' => [
            'primary' => ['label' => ['bn' => 'ডেমো চাই', 'en' => 'Request Demo'], 'href' => '#contact'],
