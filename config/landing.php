...
return [
    'defaults' => [
        ...
        'packages' => [
            ...
            ['name' => ['bn' => 'On-Premise Basic', 'en' => 'On-Premise Basic'], 'popular' => false, 'tag' => ['bn' => 'Setup', 'en' => 'Setup'], 'body' => ['bn' => 'প্রথমে আমাদের server-এ চালু হবে। ৩ মাস পর client server-এ transfer করা যাবে।', 'en' => 'Starts on our server first. After 3 months, it can be transferred to the client server.'], 'price' => '৳ 15,000', 'suffix' => ['bn' => 'setup', 'en' => 'setup'], 'features' => [['bn' => '১টি কোম্পানি', 'en' => '1 company'], ['bn' => '৩ জন user পর্যন্ত', 'en' => 'Up to 3 users'], ['bn' => 'Basic accounting setup', 'en' => 'Basic accounting setup'], ['bn' => 'Installation ও configuration', 'en' => 'Installation and configuration'], ['bn' => 'Basic user training', 'en' => 'Basic user training'], ['bn' => 'প্রথম ৩ মাস আমাদের server-এ hosted', 'en' => 'First 3 months hosted on our server'], ['bn' => 'প্রথম ৩ মাস support/hosting: ৳8,000', 'en' => 'First 3 months support/hosting: ৳8,000'], ['bn' => '৩ মাস পর client server-এ transfer অথবা আমাদের server-এ ৳5,000/month', 'en' => 'After 3 months: transfer to client server or continue on our server at ৳5,000/month']], 'button' => ['style' => 'outline', 'label' => ['bn' => 'On-Premise নিয়ে কথা বলুন', 'en' => 'Talk about On-Premise'], 'href' => '/login']],
        ],
        'pricing_notes' => [
