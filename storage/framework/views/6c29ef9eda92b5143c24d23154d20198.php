                            ...
                            <td>
                                <?php if($roleNames): ?>
                                    <div class="role-summary">
                                        <?php $__currentLoopData = $user->roles->sortBy('level'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <th>
                                        <div class="strong"><?php echo e($role->name); ?></div>
                                        <div class="permission-key">Level <?php echo e($role->level); ?></div>
                                    </th>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tr>
                        </thead>
                                ...
                                <tr>
                                    ...
                                    <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <td class="permission-decision-cell">
                                            <?php if($isFixedFullAccessRole): ?>
                                                <select class="access-select is-locked" disabled title="<?php echo e($role->name); ?> remains fixed with full access">
                                                    <option selected>Always Full</option>
                                                </select>
                                            <?php else: ?>
                                                <select
                                                    class="access-select <?php echo e($hasAccess ? 'is-allowed' : 'is-denied'); ?>"
                                                    name="permissions[<?php echo e($role->id); ?>][<?php echo e($permission['name']); ?>]"
                                                    data-access-select
                                                    <?php echo e($canManageRolePermissions ? '' : 'disabled'); ?>
                    ...
                    <div>
                        ...
                        <div class="role-list" id="roleGrid">
                            <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                ?>
                                <label class="role-option <?php echo e($canAssign ? '' : 'is-disabled'); ?>" data-role-option>
                                    <input
                                        type="checkbox"
                                        name="role_ids[]"
                                    ...
                                    <span class="role-option-body">
                                        <span class="role-option-title"><?php echo e($role->name); ?></span>
                                        <span class="role-option-desc"><?php echo e($role->description); ?></span>
                                        <?php if(!$canAssign): ?>
                                            <span class="blocked-note">Cannot assign from your current role level.</span>
                                        <?php endif; ?>
                                    </span>

                                    <span class="badge role-option-level <?php echo e($role->isSuperAdmin() ? 'badge-danger' : 'badge-neutral'); ?>">Level <?php echo e($role->level); ?></span>
                                </label>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
