                            ...
                            <tr>
                                ...
                                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $matrixUser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <th class="matrix-user-cell">
                                        <div class="strong matrix-user-title" title="<?php echo e($matrixUser->name); ?>"><?php echo e($matrixUser->name); ?></div>
                                        <div class="permission-key matrix-user-meta" title="<?php echo e($matrixUser->email); ?>"><?php echo e($matrixUser->email); ?></div>
                                        <div class="permission-key matrix-user-meta">Level <?php echo e($matrixRoleLevel); ?></div>
