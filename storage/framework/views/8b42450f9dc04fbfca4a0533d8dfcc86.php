...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Landing Admin | HisebGhor'); ?></title>
...
<div class="landing-admin-shell" id="landingAdminShell">
    <aside class="landing-admin-sidebar" id="landingAdminSidebar">
        <a href="<?php echo e(route('landing-admin.dashboard')); ?>" class="landing-admin-brand">
        ...
        <nav class="landing-admin-nav">
            <a class="landing-admin-link <?php echo e(request()->routeIs('landing-admin.dashboard') ? 'active' : ''); ?>" href="<?php echo e(route('landing-admin.dashboard')); ?>">
        ...
        <nav class="landing-admin-nav">
            <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a class="landing-admin-link <?php echo e(request()->routeIs('landing-admin.edit') && $activeSection === $section['section'] ? 'active' : ''); ?>" href="<?php echo e(route('landing-admin.edit', ['section' => $section['section']])); ?>">
                    <span class="landing-admin-icon"><?php echo e($section['icon']); ?></span><span><?php echo e($section['label']); ?></span>
                </a>
        ...
        <nav class="landing-admin-nav">
            <a class="landing-admin-link" href="<?php echo e(route('landing.public')); ?>" target="_blank">
                <span class="landing-admin-icon">↗</span><span>Open Public Page</span>
            </a>
            <form method="POST" action="<?php echo e(route('landing-admin.logout')); ?>">
                <?php echo csrf_field(); ?>
    ...
    <main class="landing-admin-main">
        <header class="landing-admin-topbar">
            ...
            <div>
                <h2><?php echo $__env->yieldContent('page_heading', 'Landing Page Admin'); ?></h2>
                <p>Dedicated dashboard for managing the public HisebGhor landing page.</p>
            </div>
            <div class="landing-admin-top-actions">
                <a href="<?php echo e(route('landing.show', ['preview' => 1])); ?>" target="_blank" class="button btn-ghost keep-mobile">Preview</a>
                <a href="<?php echo e(route('landing.public')); ?>" target="_blank" class="button btn-outline">Public Page</a>
            </div>
        </header>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/laravel/project_work/resources/views/layouts/landing-admin.blade.php ENDPATH**/ ?>