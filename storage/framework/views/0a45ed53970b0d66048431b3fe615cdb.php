...
<div class="landing-admin-grid">
    <div class="landing-editor-layout">
        ...
        <form method="POST" action="<?php echo e(route('landing-admin.update', ['section' => $activeSection])); ?>" class="landing-form" data-frontend-form>
            <?php echo csrf_field(); ?>
            ...
            <section class="landing-card landing-section-panel <?php echo e($activeSection === 'basic' ? 'is-active' : ''); ?>" id="basic" data-section-panel="basic">
                <div class="landing-card-head">
                    <div><h3>Basic, Brand & Theme</h3><p>Control publish status, SEO title, project name, language and public theme colors.</p></div>
                </div>
                <div class="landing-card-body landing-grid">
                    ...
                    <div><label>Brand Name <span class="required">*</span></label><input name="brand[name]" value="<?php echo e($value('brand.name', 'HisebGhor')); ?>" required></div>
                    <div><label>Logo Text <span class="required">*</span></label><input name="brand[logo_text]" value="<?php echo e($value('brand.logo_text', 'হি')); ?>" required></div>
                    <div><label>Tagline Bangla</label><input name="brand[tagline][bn]" value="<?php echo e($trans('brand.tagline', 'bn')); ?>"></div>
                    <div><label>Tagline English</label><input name="brand[tagline][en]" value="<?php echo e($trans('brand.tagline', 'en')); ?>"></div>
            ...
            <section class="landing-card landing-section-panel <?php echo e($activeSection === 'hero' ? 'is-active' : ''); ?>" id="hero" data-section-panel="hero">
                ...
                <div class="landing-card-body">
                    ...
                    <div class="landing-grid">
                        <div><label>Dashboard Title Bangla</label><input name="hero[dashboard][title][bn]" value="<?php echo e($trans('hero.dashboard.title', 'bn')); ?>"></div>
                        <div><label>Dashboard Title English</label><input name="hero[dashboard][title][en]" value="<?php echo e($trans('hero.dashboard.title', 'en')); ?>"></div>
                        <div><label>Dashboard Subtitle Bangla</label><input name="hero[dashboard][subtitle][bn]" value="<?php echo e($trans('hero.dashboard.subtitle', 'bn')); ?>"></div>
                        <div><label>Dashboard Subtitle English</label><input name="hero[dashboard][subtitle][en]" value="<?php echo e($trans('hero.dashboard.subtitle', 'en')); ?>"></div>
                        <div><label>Status Chip Bangla</label><input name="hero[dashboard][chip][bn]" value="<?php echo e($trans('hero.dashboard.chip', 'bn')); ?>"></div>
                        <div><label>Status Chip English</label><input name="hero[dashboard][chip][en]" value="<?php echo e($trans('hero.dashboard.chip', 'en')); ?>"></div>
                    </div>
                    <div class="muted-divider"></div>
                    <div class="landing-card-head" style="padding:0 0 14px;border:0;background:transparent"><div><h3>Dashboard Counters</h3></div><button type="button" class="button btn-outline btn-small" data-add="dashboard_stats">Add Counter</button></div>
                    <div class="repeat-list" data-repeater="dashboard_stats">
                        <?php $__currentLoopData = array_values($dashboardStats); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="repeat-card" data-repeat-item><div class="repeat-card-head"><div class="repeat-card-title">Counter</div><button type="button" class="button btn-ghost btn-small danger-link" data-remove-card>Remove</button></div><div class="landing-grid three"><div><label>Bangla Label</label><input name="hero[dashboard][stats][<?php echo e($index); ?>][label][bn]" value="<?php echo e(data_get($stat, 'label.bn')); ?>"></div><div><label>English Label</label><input name="hero[dashboard][stats][<?php echo e($index); ?>][label][en]" value="<?php echo e(data_get($stat, 'label.en')); ?>"></div><div><label>Value</label><input name="hero[dashboard][stats][<?php echo e($index); ?>][value]" value="<?php echo e(data_get($stat, 'value')); ?>"></div></div></div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    <div class="muted-divider"></div>
                    <div class="landing-card-head" style="padding:0 0 14px;border:0;background:transparent"><div><h3>Dashboard Transaction Rows</h3></div><button type="button" class="button btn-outline btn-small" data-add="dashboard_rows">Add Row</button></div>
                    <div class="repeat-list" data-repeater="dashboard_rows">
                        <?php $__currentLoopData = array_values($dashboardRows); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="repeat-card" data-repeat-item><div class="repeat-card-head"><div class="repeat-card-title">Mock Row</div><button type="button" class="button btn-ghost btn-small danger-link" data-remove-card>Remove</button></div><div class="landing-grid"><div><label>Name Bangla</label><input name="hero[dashboard][rows][<?php echo e($index); ?>][name][bn]" value="<?php echo e(data_get($row, 'name.bn')); ?>"></div><div><label>Name English</label><input name="hero[dashboard][rows][<?php echo e($index); ?>][name][en]" value="<?php echo e(data_get($row, 'name.en')); ?>"></div><div><label>Debit</label><input name="hero[dashboard][rows][<?php echo e($index); ?>][debit]" value="<?php echo e(data_get($row, 'debit')); ?>"></div><div><label>Credit</label><input name="hero[dashboard][rows][<?php echo e($index); ?>][credit]" value="<?php echo e(data_get($row, 'credit')); ?>"></div></div></div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
            </section>
            ...
            <section class="landing-card landing-section-panel <?php echo e($activeSection === 'features' ? 'is-active' : ''); ?>" id="features" data-section-panel="features">
                <div class="landing-card-head"><div><h3>Screenshots & Feature Screens</h3><p>Each screen card can have multiple badges. Put one badge per line.</p></div><label class="section-toggle"><input type="hidden" name="features[enabled]" value="0"><input type="checkbox" name="features[enabled]" value="1" <?php if($value('features.enabled', true)): echo 'checked'; endif; ?>> Enabled</label></div>
                <div class="landing-card-body">
                    ...
                    <div class="repeat-list" data-repeater="screens">
                        <?php $__currentLoopData = array_values($screens); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $screen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="repeat-card" data-repeat-item><div class="repeat-card-head"><div class="repeat-card-title">Screen Card</div><button type="button" class="button btn-ghost btn-small danger-link" data-remove-card>Remove</button></div><div class="landing-grid"><div><label>Badges Bangla <small>one per line</small></label><textarea name="screens[<?php echo e($index); ?>][badges_bn]"><?php echo e(data_get($screen, 'badges_bn', $lines(data_get($screen, 'badges', []), 'bn'))); ?></textarea></div><div><label>Badges English <small>one per line</small></label><textarea name="screens[<?php echo e($index); ?>][badges_en]"><?php echo e(data_get($screen, 'badges_en', $lines(data_get($screen, 'badges', []), 'en'))); ?></textarea></div><div><label>Title Bangla</label><input name="screens[<?php echo e($index); ?>][title][bn]" value="<?php echo e(data_get($screen, 'title.bn')); ?>"></div><div><label>Title English</label><input name="screens[<?php echo e($index); ?>][title][en]" value="<?php echo e(data_get($screen, 'title.en')); ?>"></div><div><label>Body Bangla</label><textarea name="screens[<?php echo e($index); ?>][body][bn]"><?php echo e(data_get($screen, 'body.bn')); ?></textarea></div><div><label>Body English</label><textarea name="screens[<?php echo e($index); ?>][body][en]"><?php echo e(data_get($screen, 'body.en')); ?></textarea></div></div></div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
            </section>
...
<template data-template="dashboard_stats"><div class="repeat-card" data-repeat-item><div class="repeat-card-head"><div class="repeat-card-title">Counter</div><button type="button" class="button btn-ghost btn-small danger-link" data-remove-card>Remove</button></div><div class="landing-grid three"><div><label>Bangla Label</label><input name="hero[dashboard][stats][__INDEX__][label][bn]"></div><div><label>English Label</label><input name="hero[dashboard][stats][__INDEX__][label][en]"></div><div><label>Value</label><input name="hero[dashboard][stats][__INDEX__][value]"></div></div></div></template>
<template data-template="dashboard_rows"><div class="repeat-card" data-repeat-item><div class="repeat-card-head"><div class="repeat-card-title">Mock Row</div><button type="button" class="button btn-ghost btn-small danger-link" data-remove-card>Remove</button></div><div class="landing-grid"><div><label>Name Bangla</label><input name="hero[dashboard][rows][__INDEX__][name][bn]"></div><div><label>Name English</label><input name="hero[dashboard][rows][__INDEX__][name][en]"></div><div><label>Debit</label><input name="hero[dashboard][rows][__INDEX__][debit]"></div><div><label>Credit</label><input name="hero[dashboard][rows][__INDEX__][credit]"></div></div></div></template>
