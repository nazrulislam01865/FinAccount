<?php $__env->startSection('title', 'Release Notes | HisebGhor'); ?>
...
<div class="layout release-layout">
    <div class="left-stack">
        <div class="card filters release-filters" id="releaseFilters">
            ...
            <div>
                ...
                <input id="releaseFromDate" type="date" value="<?php echo e($defaultFromDate); ?>">
            </div>

            <div>
                <label>To Date</label>
                <input id="releaseToDate" type="date" value="<?php echo e($defaultToDate); ?>">
            </div>
            ...
            <div>
                ...
                <select id="releaseUiFunctionFilter">
                    <option value="All">All</option>
                    <?php $__currentLoopData = $uiFunctions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uiFunction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($uiFunction); ?>"><?php echo e($uiFunction); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            ...
            <div>
                ...
                <select id="releaseItemTypeFilter">
                    ...
                    <?php $__currentLoopData = $itemTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($itemType); ?>"><?php echo e($itemType); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            ...
            <div>
                ...
                <select id="releaseVersionFilter">
                    <option value="All">All</option>
                    <?php $__currentLoopData = $releaseVersions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $releaseVersion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($releaseVersion); ?>"><?php echo e($releaseVersion); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
        ...
        <div class="card table-card release-table-card">
            ...
            <div class="table-wrap">
                <table id="releaseItemsTable">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $releaseItems->groupBy(fn ($item) => $item->release_date?->toDateString() ?: 'No Date'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $releaseDate => $itemsForDate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="release-group" data-release-group data-date="<?php echo e($releaseDate); ?>" data-label="<?php echo e($releaseDate === 'No Date' ? 'No Date' : \Carbon\Carbon::parse($releaseDate)->format('d M Y')); ?>">
                                <td colspan="9">
                                    <?php echo e($releaseDate === 'No Date' ? 'No Date' : \Carbon\Carbon::parse($releaseDate)->format('d M Y')); ?>

                                    — <?php echo e($itemsForDate->count()); ?> released item(s)
                                    • <?php echo e($itemsForDate->pluck('module')->unique()->implode(', ')); ?>

                                </td>
                            </tr>

                            <?php $__currentLoopData = $itemsForDate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $releaseItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr
                                    class="release-row"
                                    data-id="<?php echo e($releaseItem->id); ?>"
                                    data-date="<?php echo e($releaseItem->release_date?->toDateString()); ?>"
                                    data-module="<?php echo e(e($releaseItem->module)); ?>"
                                    data-ui-function="<?php echo e(e($releaseItem->ui_function)); ?>"
                                    data-item-type="<?php echo e(e($releaseItem->item_type)); ?>"
                                    data-task="<?php echo e(e($releaseItem->task)); ?>"
                                    data-note="<?php echo e(e($releaseItem->note)); ?>"
                                    data-user-impact="<?php echo e(e($releaseItem->user_impact)); ?>"
                                    data-released-by="<?php echo e(e($releaseItem->released_by)); ?>"
                                    data-release-version="<?php echo e(e($releaseItem->release_version)); ?>"
                                    data-status="<?php echo e(e($releaseItem->status)); ?>"
                                    data-update-url="<?php echo e(url('/api/release-notes/' . $releaseItem->id)); ?>"
                                >
                                    <td class="module strong"><?php echo e($releaseItem->module); ?></td>
                                    <td><span class="badge <?php echo e($uiBadgeClass($releaseItem->ui_function)); ?>"><?php echo e($releaseItem->ui_function); ?></span></td>
                                    <td><span class="badge <?php echo e($typeBadgeClass($releaseItem->item_type)); ?>"><?php echo e($releaseItem->item_type); ?></span></td>
                                    <td class="release-task-cell">
                                        <strong><?php echo e($releaseItem->task); ?></strong>
                                        <?php if($releaseItem->note): ?>
                                            <span><?php echo e($releaseItem->note); ?></span>
                                        <?php endif; ?>
                                    </td>
                                    <td class="impact"><?php echo e($releaseItem->user_impact ?: '—'); ?></td>
                                    <td class="owner"><?php echo e($releaseItem->released_by ?: $releaseItem->creator?->name ?: '—'); ?></td>
                                    <td><span class="badge <?php echo e($versionBadgeClass($releaseItem->release_version)); ?>"><?php echo e($releaseItem->release_version); ?></span></td>
                                    <td><span class="badge <?php echo e($statusBadgeClass($releaseItem->status)); ?>"><?php echo e($releaseItem->status); ?></span></td>
                                    <td>
                                        <div class="action-cell">
                                            <?php if($canManageReleaseNotes): ?>
                                                ...
                                                <form
                                                    method="POST"
                                                    data-delete-form
                                                    action="<?php echo e(url('/release-notes/' . $releaseItem->id)); ?>"
    ...
    <aside class="right-stack release-form-stack">
        <form
            ...
            id="releaseItemForm"
            data-frontend-form
            data-action="<?php echo e(route('api.release-notes.store')); ?>"
            data-create-action="<?php echo e(route('api.release-notes.store')); ?>"
        ...
        >
            ...
            <div class="panel-head">
                <div>
                    ...
                    <p class="muted"><?php echo e($canManageReleaseNotes ? 'Your role can manage release records from the role matrix.' : 'Your role can view release records only; create, edit, and delete are blocked by the role matrix.'); ?></p>
                </div>
            ...
            <div class="form-grid">
                <div>
                    ...
                    <input type="date" name="release_date" id="releaseDate" value="<?php echo e($today); ?>" required>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="released_by" id="releaseBy" maxlength="120" value="<?php echo e(auth()->user()?->name); ?>" placeholder="Team or person name">
                </div>
                    ...
                    <div>
                        ...
                        <select name="status" id="releaseStatus" required>
                            <?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($status); ?>" <?php if($status === 'Released'): echo 'selected'; endif; ?>><?php echo e($status); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                </div>
...
(function () {
    ...
    const defaultFromDate = <?php echo json_encode($defaultFromDate, 15, 512) ?>;
    const defaultToDate = <?php echo json_encode($defaultToDate, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/laravel/project_work/resources/views/release-notes/index.blade.php ENDPATH**/ ?>