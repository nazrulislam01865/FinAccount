      ...
      <div class="contact-card">
        ...
        <div class="contact-methods">
          <?php if(data_get($landing, 'contact.phone')): ?>
            <a class="contact-method" href="<?php echo e($landingWhatsAppUrl(data_get($landing, 'contact.phone'))); ?>" target="_blank" rel="noopener"><span class="tick">☎</span><div><b><?php echo e(data_get($landing, 'contact.phone')); ?></b><span data-bn="<?php echo e($txt(data_get($landing, 'contact.phone_note'), 'bn')); ?>" data-en="<?php echo e($txt(data_get($landing, 'contact.phone_note'), 'en')); ?>"><?php echo e($txt(data_get($landing, 'contact.phone_note'), $defaultLang)); ?></span></div></a>
          <?php endif; ?>
