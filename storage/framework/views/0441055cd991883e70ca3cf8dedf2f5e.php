<?php $__env->startSection('title', 'Advance Management | HisebGhor'); ?>
...
<div class="stats-grid advance-stats">
    ...
    <div class="card stat-card">
        ...
        <form
            ...
            id="advanceForm"
            action="<?php echo e(route('api.advance-management.store')); ?>"
            method="POST"
            data-new-rules='<?php echo json_encode($newAdvanceRules->values(), 15, 512) ?>'
            data-adjustment-rules='<?php echo json_encode($adjustmentRules->values(), 15, 512) ?>'
        >
            <?php echo csrf_field(); ?>
                ...
                <div>
                    ...
                    <select id="advancePartySelect" required>
                        ...
                        <?php $__currentLoopData = $parties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $party): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($party->id); ?>"><?php echo e($party->party_name); ?><?php echo e($party->partyType?->name ? ' - ' . $party->partyType?->name : ''); ?></option>
            ...
            <div class="actions">
                ...
                <?php if($canManageAdvance): ?>
                    <button class="btn-primary" type="submit" id="advanceSubmitButton">Post Advance</button>
                <?php endif; ?>
            </div>
        </form>

<form class="card toolbar advance-toolbar" method="GET" action="<?php echo e(route('advance-management.index')); ?>" style="margin-top:18px">
    ...
    <div>
        ...
        <select name="advance_type">
            <?php $__currentLoopData = ['All', 'Advance Paid', 'Advance Received']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($type); ?>" <?php if($filters['advance_type'] === $type): echo 'selected'; endif; ?>><?php echo e($type); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
    </div>
    <div>
        <label>Status</label>
        <select name="status">
            <?php $__currentLoopData = ['All', 'Open', 'Partially Adjusted', 'Fully Adjusted']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="left-stack">
        <div class="card table-card">
            <div class="card-head">
                ...
                <span class="badge badge-primary"><?php echo e($advanceRows->count()); ?> record(s)</span>
            </div>
            <div class="table-wrap">
                <table id="advanceManagementTable" data-client-pagination="true" data-page-size="10">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $advanceRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr
                                data-advance-row
                                ...
                                data-advance-type="<?php echo e($row['advance_type']); ?>"
                                data-advance-type-label="<?php echo e($row['advance_type_label']); ?>"
                                data-balance="<?php echo e($row['balance']); ?>"
                                data-linked-due-balance="<?php echo e($row['linked_due_balance'] ?? 0); ?>"
                                data-linked-due-label="<?php echo e(e($row['linked_due_label'] ?? '')); ?>"
                                data-max-adjustment="<?php echo e($row['max_adjustment'] ?? 0); ?>"
                                data-original="<?php echo e($row['original_amount']); ?>"
                                data-adjusted="<?php echo e($row['adjusted_amount']); ?>"
                                data-status="<?php echo e($row['status']); ?>"
                            >
                                <td><?php echo e($dateLabel($row['advance_date'])); ?></td>
                                ...
                                <td><span class="badge <?php echo e($typeClass($row['advance_type'])); ?>"><?php echo e($row['advance_type_label']); ?></span></td>
                                <td class="money-cell"><?php echo e($money($row['original_amount'])); ?></td>
                                <td class="money-cell"><?php echo e($money($row['adjusted_amount'])); ?></td>
                                <td class="money-cell strong"><?php echo e($money($row['balance'])); ?></td>
                                ...
                                <td>
                                    <div class="action-cell">
                                        <?php if($canManageAdvance && $row['balance'] > 0): ?>
            ...
            <div class="table-footer">
                <span>Showing <?php echo e($advanceRows->count()); ?> advance balance row(s)</span>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/laravel/project_work/resources/views/advance-management/index.blade.php ENDPATH**/ ?>