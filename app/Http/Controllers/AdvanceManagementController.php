...
class AdvanceManagementController extends Controller
{
    ...
    public function store(Request $request, AccountingEngineContract $engine): JsonResponse
    {
        ...
        try {
            ...
            return response()->json([
                'success' => false,
                'message' => 'Advance posting failed: ' . ($exception->getMessage() ?: 'Please check Financial Year, Voucher Numbering, Cash/Bank, Party, Advance Mapping, and Accounting Rules Setup.'),
            ], 500);
        }
    }
