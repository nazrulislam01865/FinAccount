...
class SrsApiController extends Controller
{
    ...
    private function normaliseRuleLineLedgerSource(?string $source): string
    {
        ...
        return match ($source) {
            ...
            'customer_receivable', 'party_receivable' => 'party_receivable',
            'supplier_payable', 'party_payable' => 'party_payable',
            'salary_payable', 'party_salary_payable' => 'party_salary_payable',
            'party_advance_paid' => 'party_advance_paid',
            'party_advance_received' => 'party_advance_received',
            'party_loan_payable' => 'party_loan_payable',
            'party_capital', 'owner_capital' => 'party_capital',
            'party_control', 'party' => 'party_control',
