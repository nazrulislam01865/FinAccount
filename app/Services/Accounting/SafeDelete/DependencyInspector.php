    ...
    public function transaction(Transaction $transaction): DeletionPlan
    {
        ...
        return new DeletionPlan(
            ...
            $this->nonZero([
                ...
                ['Generated Payment Receipt', $transaction->paymentReceipt()->exists() ? 1 : 0, 'The customer/supplier payment receipt generated from this due settlement will also be deleted.'],
            ...
            'Journal entries, journal lines, attachments, generated sales invoices, generated payment receipts, and feed stock movements are deleted together. Feed stock is restored to its exact balance before the transaction.',
        );
    }
