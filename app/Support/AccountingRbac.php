...
final class AccountingRbac
{
    ...
    public static function permissions(): array
    {
        return [
            ...
            self::permission('transaction_categories.view', 'Configuration', 'View', 'View Transaction Categories', 'Open transaction category master data.', 'master.index', 90),
            self::permission('transaction_categories.manage', 'Configuration', 'Manage', 'Manage Transaction Categories', 'Create and update transaction categories. Deletion also requires Delete Records.', 'master.store', 91),
