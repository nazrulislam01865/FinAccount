        ...
        <div class="left-stack opening-balance-full-stack">
            ...
            <div class="card balance-card">
                ...
                <div class="table-wrap">
                    <table id="openingBalanceTable" data-client-pagination="true" data-page-size="10">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Account Code</th>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('addRowBtn')?.addEventListener('click', () => {
        addRow();
        window.AccountingTablePagination?.refresh(document.getElementById('openingBalanceTable'), false);
