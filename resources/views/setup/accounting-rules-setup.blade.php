    ...
    <section class="card prototype-card prototype-section" id="ruleListCard">
        ...
        <div class="prototype-card-body">
            ...
            <div class="table-wrap prototype-table-wrap always-scroll">
                <table id="ruleTable" data-client-pagination="true" data-page-size="10">
                    <thead>
                        <tr>
                            <th>Rule Code</th>
                            <th>Rule Name</th>
                        ...
                        @forelse($rules as $rule)
                            ...
                            >
                                ...
                                <td>
                                    ...
                                    @if($rule->status === 'Inactive' && (! $primary || (! $counter && str_contains(strtolower((string) $rule->counter_ledger_source), 'fixed'))))
